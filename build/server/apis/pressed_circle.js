...
export async function pressedCircle(req, res) {
    ...
    const updatedUsers = await Promise.all(someparsedvalue.map((user) => {
        if (user.username !== token.username) {
            return Object.assign(Object.assign({}, user), { health: user.health - 1 });
        }
        return user;
    }));
...
//# sourceMappingURL=pressed_circle.js.map